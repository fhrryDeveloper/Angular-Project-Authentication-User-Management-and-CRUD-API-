...
@Component({
  templateUrl: './admininfomanage.component.html'
})
export class AdmininfomanageComponent {
  details: UserDetails
  selectstatus: any; firstname: any; lastname: any; id: any; alldatas: any; email: any; partnerselectstatus: any; userid: any;
  userfirstname: any; userlastname: any; useremail: any;
  form: FormGroup;
  ...
  constructor(private _notifications: NotificationsService,private auth: AuthenticationService, private router: Router,private _fb: FormBuilder,private route: ActivatedRoute) {}

  ngOnInit() {
    this.alldatas = [];
    this.userid = this.route.snapshot.paramMap.get('id');
    this.userfirstname = this.route.snapshot.paramMap.get('firstname');
    this.userlastname = this.route.snapshot.paramMap.get('lastname');
        ...
        this.auth.getUserinfo(this.id).subscribe(
          data => {
            if(data.error)
            {
              ...
              this.alldatas = {
                userid: this.id, firstname: this.userfirstname, lastname: this.userlastname, email: this.useremail,
                ...
                partnerpreviousrentvalue: '', partnersubletvalue: '', petsquestionnovalue: false, musicalyesvalue: true, vehicleyesvalue: true, listingvalue: false, internetvalue: true,
                partnervehicleyesvalue: true, partnercurrentvalue: '', partnertelephonevalue: '', nametagvalue: '', residencebvalue: false, residencecvalue: false, residencedvalue: false,
                ...
                petsquestionyesvalue: true, musicalnovalue: false, vehiclenovalue: false, othersvalue: false, rentalvalue: false, partnervehiclenovalue: false, fourthemploymentinputvaluefull: true,
